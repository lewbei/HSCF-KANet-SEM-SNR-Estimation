...
git -C model/sota/github/ARNIQA checkout 66d16eb0ff1e1655872d32c0c233614a3922aaad
...
CalibNet results are included in the canonical result tables. Re-evaluating its original checkpoints requires the matching `CalibNet.py` architecture definition to be placed in `model/`; that source was not part of the final local code snapshot used to assemble this reproducibility release.
